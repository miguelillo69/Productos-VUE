        ...
        <div class="col-sm-6 col-md-4 col-lg-4 addProduct">
            <div class="newProduct">
                ...
                <form id="new-prod" @submit.prevent="addProduct" @reset.prevent="resetForm" novalidate>
                    <fieldset>
                        <legend class="bg-dark text-white text-center" id="tabla_prod">{{ this.id ? 'Modificar ' : 'Añadir ' }} producto</legend>
                        ...
                        <div class="form-group">
                            <label for="newprod-name">Nombre:
                                <input type="text" v-model="product.nombre" id="newprod-name" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" v-model="product.uds" id="newprod-units" class="form-control" min="0"
                                max="100">
                            <span class="error"></span>
                        </div>
                        <div class="form-group">
                            <label for="newprod-price">Precio/u.:</label>
                            <input type="number" v-model="product.precio" id="newprod-price" class="form-control"
                                min="0" step="0.01" required>
                            <span class="error"></span>
                        </div>
                        <br>
                        <button type="submit" id="boton_añadir_modificar" class="btn btn-default btn-dark">{{ this.id ?
                                'Modificar ' : 'Añadir '
                        }}</button>
